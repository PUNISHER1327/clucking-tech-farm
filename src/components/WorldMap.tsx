  ...
  return (
    <div className="relative w-full h-full">
      <svg viewBox="0 0 1000 500" className="w-full h-full opacity-80">
        {/* World map paths for each continent - simplified */}
        {/* North America */}
        <path 
        ...
        {/* Map location dots representing presence */}
        <circle cx="480" cy="190" r="8" className="fill-orange-500 animate-pulse-glow" />
        <circle cx="535" cy="350" r="8" className="fill-orange-500 animate-pulse-glow" />
        <circle cx="700" cy="250" r="8" className="fill-orange-500 animate-pulse-glow" />
        <circle cx="830" cy="450" r="8" className="fill-orange-500 animate-pulse-glow" />
      ...
      <div className="absolute inset-0 bg-gradient-radial from-orange-500/5 to-transparent pointer-events-none"></div>
    </div>
  );
};
